...
<body>
  ...
  <div class="series__back-button">
    <a class="series__back-button--full" href="./gallery.php">
      ...
      <span class="series__back-button--back">Back</span>
    </a>
  </div>
  ...
  <main>
    <div class="series">
      <div class="cont">
        <h1 class="series__title title">Series "Resident of the city"</h1>
      </div>
      <div class="series-box" id="series-box"></div>
    </div> 
  ...
  <script src="./src/scripts/series.js"></script>
