    ...
    <nav class="navigation">
      ...
      <div class="navigation__right">
        ...
        <ul class="navigation__list">
          ...
          <li class="navigation__list--item"><a href="#">About Me</a></li>
          <li class="navigation__list--item"><a href="#">My CV</a></li>
          <li class="navigation__list--item"><a href="./gallery">Gallery</a></li>
          <li class="navigation__list--item"><a href="#">Contacts</a></li>
        </ul>
